...
const UpComingReservationList = (props: Props) => {
  const { handleEnterChat } = props;
  ...
  return (
    <View style={styles.upcomingReservationContainer}>
      ...
      <ScrollView horizontal contentContainerStyle={styles.upcomingReservationList} showsHorizontalScrollIndicator={false}>
        <UpComingReservation roomId="1" imageUri="https://fastly.picsum.photos/id/212/200/300.jpg?hmac=2PUnX8vk476_x3NwjUExdYhPxVyP1Qd17BLvvBYTONQ" title="동천역 강아지 산책" dateTime="2025. 6. 22. (일) 18:00" handleEnterChat={handleEnterChat} />
      </ScrollView>
    </View>
  );
};
